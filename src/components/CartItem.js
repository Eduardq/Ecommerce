...
const CartItem = () => {
  ...
  return (
    <div className='w-2/3 pr-10'>
        ...
        <div>
            {
                productData.map((item) => (
                    <div key={item._id}
                        ...
                        <div className='border p-3 flex items-center gap-4 text-sm font-semibold'>
                            ...
                            {item.quantity}
                             ...
                             onClick={()=> 
                                ...
                                className='border h-5 font-normal text-lg flex items-center
                                 justify-center px-2 hover:text-white cursor-pointer 
        ...
        className='bg-red-500 text-white mt-8 ml-7 py-1 px-7 hover:bg-red-800
         duration-300'>
            Reset Cart</button>
        <Link to='/'>
