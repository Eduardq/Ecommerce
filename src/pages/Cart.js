...
const Cart = () => {
  ...
  return (
    <div>
      ...
      src='https://images.pexels.com/photos/1435752/pexels-photo-1435752.jpeg?auto=compress&cs=tinysrgb&w=600'
      alt='cartImg'/>
          ...
          hover:bg-gray-800 duration-300'>
            proceed to checkout</button>
            {
              ...
              <div className='w-full mt-6 flex items-center justify-center'>
                <StripeCheckout
                stripeKey='pk_test_51NuwxXLkvsUGIXQbYU8qCvPJSjCr6AipIdmMGR0ZJxNDKyt7tdDruDgehXsTG0dO7KEUhqCksBXYJDx0fSd8x6Bo00fFlNzINH'
                name='bazar'
                amount={totalAmt * 100}
                Label='Pay to bazar'
